export default function Hero() {
  return (
    <section
      className="relative overflow-hidden text-white min-h-[480px] sm:min-h-[540px] lg:min-h-[600px] flex items-center"
      style={{
        background: "linear-gradient(135deg, #1a2a2a 0%, #2C3E3E 50%, #1a3030 100%)",
      }}
    >
      {/* Subtle line pattern */}
      <div
