      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-14">
          ...
          <div className="flex flex-col items-center text-center p-6 rounded-lg bg-light-bg border border-border">
            ...
            <p className="text-sm text-mid-gray mb-1">Besöksadress</p>
            <p className="font-semibold text-charcoal">Satellitvägen 16</p>
            <p className="text-sm text-mid-gray">245 34 Staffanstorp</p>
          </div>
          <div className="flex flex-col items-center text-center p-6 rounded-lg bg-light-bg border border-border">
            <MapPin className="w-5 h-5 text-teal mb-3" />
            <p className="text-sm text-mid-gray mb-1">Serviceområde</p>
            <p className="font-semibold text-charcoal text-sm">Malmö, Lund, Staffanstorp, Lomma, Vellinge, Trelleborg m.fl.</p>
          </div>
        </div>
